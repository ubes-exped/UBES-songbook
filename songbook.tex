...
% Leave more space at the top, as the section title will move up to fill this
% space
\usepackage[a5paper, top=1.5cm, bottom=0.6cm, hmargin=2cm]{geometry}
\usepackage[utf8]{inputenc}

% Define paragraph spacing
\usepackage[skip=12pt]{parskip}

% Define the spacing around the sub*section headers
\usepackage{titlesec}
\newcommand{\sectionbreak}{\clearpage}
% For \section, move into the header.
\titleformat{\section}{\normalfont\fontsize{12}{18}\bfseries\filcenter}{\thesection}{0em}{\vspace*{-1.85cm}}
\titlespacing{\section}{0pt}{40pt}{30pt}

\titleformat{\subsection}{\normalfont\fontsize{10}{14}\bfseries\filcenter}{\thesubsection}{0em}{}
\titlespacing{\section}{0pt}{30pt}{20pt}

\titleformat{\subsubsection}{\normalfont\fontsize{9}{12}\bfseries\filcenter}{\thesubsubsection}{0em}{}
...
% Verse/lyric printing
\usepackage{verse}

% Do not indent the verse
...
% Use dots to join name and page
\renewcommand{\cftsecleader}{\cftdotfill{\cftdotsep}}
% Do not use bold face for contents
\renewcommand\cftsecfont{\mdseries}
% Allow the contents entries to be clicked on
...
% Show the page number in the top outer corner
\fancyhead[LO]{\smash{\raisebox{-0.5cm}{\makebox[-1cm][r]{\makebox[0pt][c]{\thepage}}}}} % Left side on even pages
\fancyhead[RE]{\smash{\raisebox{-0.5cm}{\makebox[-1cm][l]{\makebox[0pt][c]{\thepage}}}}} % Right side on odd pages
...
% Fix the size of the verse text
...
% Define \chorusdef for marking the first occurrence of the chorus,
% and \chorusmark for the subsequent occurrences.
\makeatletter
\newcommand{\chorusdef}{\textbf{\emph{Chorus:}}\\*}
\setlength{\stanzaskip}{8.5pt}
...
% Define stage directions in gray
...
Well I’ll be feelin’ merry when I marry Mary Mac! \\*
Do-do-do-do-do-do-do-do-dooo!

This little girl, her name is Mary Mac, \\*
Make no mistake, she’s the girl I’m gonna track, \\*
A lot of other fellas wanna get her on her back, \\*
But I’m thinking that they’ll have to get up early.

\chorusmark

This sweet lass, she’s got a lot of class, \\*
Got a lotta cash, she thinks I’m a gas, \\*
I’d be a silly ass if I let the matter pass, \\*
Her mother thinks she suits me rather fairly.
